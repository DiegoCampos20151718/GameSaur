...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "commander", "zod", "../util/handle-error", "path", "fs", "@clack/prompts"], factory);
    }
    ...
    const updateOptionsSchema = zod_1.z.object({
    ...
    exports.update = new commander_1.Command()
        .name('add')
        ...
        try {
            if (command.args.length > 1) {
                prompts_1.log.error('\x1b[31mOnly one component can be provided at a time, please provide the component name you want to update or --all.\x1b[0m');
                process.exit(1);
            }
            const options = updateOptionsSchema.parse(Object.assign({ components: components !== null && components !== void 0 ? components : '' }, opts));
