...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "fs-extra", "path", "process", "util", "os", "./utils", "../utils", "@clack/prompts", "../installer/utils"], factory);
    }
    ...
    const utils_3 = require("../installer/utils");
    ...
    const copyFolders = (sourcePath, targetPath, specificComponent, isUpdate, forceUpdate = false) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const checkIfComponentIsValid = (component) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (componentList.includes(component) ||
            componentList.includes((0, utils_2.dashToPascal)(component))) {
            return true;
        }
        return false;
    });
    ...
    const initialProviderAdder = (componentFolderPath
    // projectType: string
