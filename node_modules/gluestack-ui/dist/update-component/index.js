...
(function (factory) {
    ...
    function updateComponent(component = '', forceUpdate = false) {
            ...
            try {
                ...
                if (component === '--all') {
                    ...
                    for (const component of requestedComponents) {
                        yield (0, component_adder_1.componentAdder)(component, false, true, forceUpdate);
                    }
                }
                else {
                    let shouldContinue = true;
                    if (forceUpdate) {
                        shouldContinue = yield (0, prompts_1.confirm)({
