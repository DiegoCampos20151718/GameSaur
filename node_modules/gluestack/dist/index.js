...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@clack/prompts", "child_process"], factory);
    }
    ...
    function main() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let choice = yield (0, prompts_1.select)({
            ...
            switch (choice) {
                case 'next-with-gluestack-ui':
                    (0, child_process_1.spawnSync)(`npx create-next-app-with-gluestack-ui@latest ${args.join(' ')}`, {
                        cwd: process.cwd(),
                        stdio: 'inherit',
                        shell: true,
                    });
                ...
                case 'expo-with-gluestack-ui':
                    (0, child_process_1.spawnSync)(`npx create-expo-app-with-gluestack-ui@latest ${args.join(' ')}`, {
                        cwd: process.cwd(),
                        stdio: 'inherit',
                        shell: true,
                    });
                ...
                case 'react-native-with-gluestack-ui':
                    (0, child_process_1.spawnSync)(`npx create-react-native-app-with-gluestack-ui@latest ${args.join(' ')}`, {
                        cwd: process.cwd(),
                        stdio: 'inherit',
                        shell: true,
                    });
                    break;
                default:
                    prompts_1.log.info(` That option is coming soon! \x1b[33m Stay tuned!\x1b!`);
                    break;
            }
            console.log('');
        });
